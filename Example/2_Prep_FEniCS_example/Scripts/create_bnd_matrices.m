function create_bnd_matrices(overwriteOutput ,tissue_mat, water_ind, bnd_heat_trans, bnd_temp)
...
exist_HT            = exist(get_path('bnd_heat_transfer_mat'),'file');
exist_temp          = exist(get_path('bnd_temp_mat'),'file');
exist_temp_times_HT = exist(get_path('bnd_temp_mat'),'file');
...
save(get_path('bnd_heat_transfer_mat'), 'bnd_heat_trans_mat', '-v7.3');
save(get_path('bnd_temp_mat'), 'bnd_temp_mat', '-v7.3');
save(get_path('bnd_temp_times_ht_mat'), 'bnd_temp_times_ht_mat', '-v7.3');
end
