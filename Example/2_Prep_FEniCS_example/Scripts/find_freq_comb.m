...
switch fileType
    ...
    case 'settings_complex'
        for i = freq_vec
            for j = freq_vec
                name = ['1_Efield_results_adv' filesep 'settings_complex_' ...
                    modelType '_1_' num2str(i) '_2_' num2str(j) 'MHz'];
                if exist([rootpath filesep name '_(1).mat'], 'file') || ...
                    exist([rootpath filesep name '.mat'], 'file')
