function [] = EF_optimizationFrequencies(f1, f2)
%[P] = EF_OPTIMIZATION()
...
resultpath = [rootpath filesep '..' filesep strcat('1_Efield_results_frequencies',num2str(f1),num2str(f2))];
...
save([resultpath filesep 'P_C.mat'], 'mat_2', '-v7.3');

save([resultpath filesep 'P_htq.mat'], 'mat_3', '-v7.3');

save([resultpath filesep 'Time Distribution'], 'x', '-v7.3');
% Empty load_maestro
