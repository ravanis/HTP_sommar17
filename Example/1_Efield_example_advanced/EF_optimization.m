function [lin_htq_mat,lin_m1_mat,lin_m2_mat, quad_htq_mat,quad_m1_mat,quad_m2_mat] = EF_optimization()
%[P] = EF_OPTIMIZATION()
...
%   saved to the results folder.
    ...
    tissue_mat = Yggdrasil.Utils.load([datapath filesep 'tissue_mat.mat']);
